...
public class CreateChildObjectsTest : MonoBehaviour
{

	public HierarchicalObjectContainer fooTest;


	void Reset ()
	{
		if (null == fooTest) {
			fooTest = new HierarchicalObjectContainer ();
		}
		fooTest.Reset ();
//		if (childContainer != null) {
//			// We already have one, let's not delete it
//
//		}
		//childContainerParent = this;
	}
	...
	public void CreateChildren ()
	{
		...
		fooTest.CreateChildren (gameObject, () => 3, (i, c, ctx) => c.AddComponent<MeshCollider> (), this);
